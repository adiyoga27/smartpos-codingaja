...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('stok.opname') }}">Stock Opname</a></li>
...
<div class="card">
    <div class="card-header flex items-center justify-between">
        ...
        <a href="{{ route('stok.opname') }}" class="btn btn-sm btn-outline-secondary"><i class="bi bi-arrow-left"></i> Kembali</a>
    </div>
    <div class="card-body">
        <form action="{{ route('stok.opname.form') }}" method="GET" id="selectForm">
            <div class="mb-3">
            ...
            <div class="mt-4">
                <button type="submit" class="btn btn-primary btn-md" id="submitBtn" disabled>
                    <i class="bi bi-arrow-right mr-1"></i> Lanjut Input Stok Fisik
                </button>
            </div>
        </form>
    </div>
