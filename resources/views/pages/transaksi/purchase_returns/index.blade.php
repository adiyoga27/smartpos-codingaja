...
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('transaksi.purchase_returns.index') }}">Transaksi</a></li>
    <li class="breadcrumb-item active">Return Pembelian</li>
@endsection
@section('content')
<div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    <h4 class="font-bold mb-0">Return Pembelian</h4>
    <a href="{{ route('transaksi.purchase_returns.create') }}" class="btn btn-primary btn-md"><i class="bi bi-plus-lg"></i> Buat Return</a>
</div>
<div class="card">
    <div class="card-body">
        <div class="overflow-x-auto">
            <table class="table table-striped" id="purchase-returns-table" style="width:100%">
                <thead>
                    <tr><th>No. Dokumen</th><th>No. PO</th><th>Supplier</th><th>Tanggal</th><th>Total</th><th>Aksi</th></tr>
                </thead>
            </table>
        </div>
    </div>
...
$(document).ready(function() {
    $('#purchase-returns-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{{ route('transaksi.purchase_returns.index') }}',
        pageLength: 25,
        dom: 'Bfrtip',
        buttons: [
