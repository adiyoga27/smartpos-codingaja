...
@section('breadcrumb')
    ...
    <span class="text-slate-600">Piutang</span>
@endsection
@section('content')
<div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    <h4 class="font-bold mb-0">Laporan Piutang</h4>
</div>
<div class="card">
    <div class="card-body p-0">
        <div class="overflow-x-auto">
            <table class="table table-striped mb-0" id="report-piutang-table" style="width:100%">
                <thead><tr><th>No. Dokumen</th><th>Customer</th><th>Jatuh Tempo</th><th>Jumlah</th><th>Diterima</th><th>Sisa</th></tr></thead>
            </table>
        </div>
    </div>
</div>
...
$(document).ready(function() {
    $('#report-piutang-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{{ route('laporan.piutang') }}',
        pageLength: 25,
        dom: 'Bfrtip',
        buttons: [
