...
<div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    <h4 class="font-bold mb-0">Laporan Pembelian</h4>
...
<div class="card">
    <div class="card-body p-0">
        <div class="overflow-x-auto">
            <table class="table table-striped mb-0" id="report-pembelian-table" style="width:100%">
                <thead><tr><th>No. PO</th><th>Supplier</th><th>Tanggal</th><th>Total</th></tr></thead>
            </table>
        </div>
    </div>
</div>
...
$(document).ready(function() {
    var table = $('#report-pembelian-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
